...
INSERT INTO ContractStation SET contractId=@contrId, numberInSequence=2, kind="unload",
...
INSERT INTO ContractStation SET contractId=@contrId, numberInSequence=1, kind="load",
   weightKg=1000, volumeM3=3.2, volumeUnits=0,
